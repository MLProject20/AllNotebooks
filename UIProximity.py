...
class Proximity():
    ...
    def summarize(self,NearResidentialOutputTable,HousingUnitsTable,Geodatabase):
        ...
        self.PercentUnitsFieldName = 'm'+ NearResidentialOutputTable[1:]  #Name for PercentField
    ...
    def exportcsv(self,OutputDirectory,FinalCSVName):
        ...
        FinalFile = pd.DataFrame(GIScsvfile[['NPA', 'Year', self.NearResidentialOutputTable,
